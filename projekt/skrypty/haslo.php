    ...
    if ($result && mysqli_num_rows($result) == 1) {
        ...
        if ($insertResult||$updateResult) {
            ...
            if ($deleteResult) {
                ...
                echo "Wystąpił błąd podczas usuwania rekordu z tabeli rejestracja.";
            }
        } else {
            echo "Wystąpił błąd podczas zapisywania nowego hasła do bazy danych.";
        }
    } else {
        echo "Nie znaleziono użytkownika dla podanego kodu.";
    }
